sap.ui.define([
	...
	function onRiseEmployee(oEvent){
		if(!this.riseDialog){
			...
			this.riseDialog = sap.ui.xmlfragment("logaligroup/rrhh/HTML5Module/fragment/RiseEmployee", this);
	...
	return Controller.extend("empleados.empleados.controller.ShowEmployee", {
		onInit: onInit,
